module github.com/joerit/pulumi-boundary/provider
...
require (
	github.com/joerit/terraform-provider-boundary v0.0.0-20251006141928-7a6342cd181b
...
require (
	...
	github.com/hashicorp/go-secure-stdlib/configutil/v2 v2.0.12 // indirect
