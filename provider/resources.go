...
import (
	...
	boundary "github.com/joerit/terraform-provider-boundary/provider" // Import the upstream provider

	"github.com/joerit/pulumi-boundary/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-boundary/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-boundary/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "boundary", boundary.Provider(),
		...
		// convention is to have a function at "github.com/joerit/terraform-provider-boundary/provider".New
		...
		Keywords:   []string{"boundary", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://github.com/joerit/pulumi-boundary",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/joerit/pulumi-boundary/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("boundary_", mainMod,
