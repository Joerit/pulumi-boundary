...
namespace Pulumi.Boundary
{
    ...
    /// ```
    /// </summary>
    [BoundaryResourceType("boundary:index/authMethod:AuthMethod")]
    public partial class AuthMethod : global::Pulumi.CustomResource
    {
        ...
        public AuthMethod(string name, AuthMethodArgs args, CustomResourceOptions? options = null)
            : base("boundary:index/authMethod:AuthMethod", name, args ?? new AuthMethodArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthMethod(string name, Input<string> id, AuthMethodState? state = null, CustomResourceOptions? options = null)
            : base("boundary:index/authMethod:AuthMethod", name, state, MakeResourceOptions(options, id))
        {
        }
