...
namespace Pulumi.Boundary
{
    ...
    public partial class CredentialLibraryVault : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("credentialMappingOverrides")]
        public Output<ImmutableDictionary<string, string>?> CredentialMappingOverrides { get; private set; } = null!;
        ...
        public CredentialLibraryVault(string name, CredentialLibraryVaultArgs args, CustomResourceOptions? options = null)
            : base("boundary:index/credentialLibraryVault:CredentialLibraryVault", name, args ?? new CredentialLibraryVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CredentialLibraryVault(string name, Input<string> id, CredentialLibraryVaultState? state = null, CustomResourceOptions? options = null)
            : base("boundary:index/credentialLibraryVault:CredentialLibraryVault", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CredentialLibraryVault Get(string name, Input<string> id, CredentialLibraryVaultState? state = null, CustomResourceOptions? options = null)
        {
            return new CredentialLibraryVault(name, id, state, options);
        }
    }

    public sealed class CredentialLibraryVaultArgs : global::Pulumi.ResourceArgs
    {
        [Input("credentialMappingOverrides")]
        private InputMap<string>? _credentialMappingOverrides;

        /// <summary>
        /// The credential mapping override.
        /// </summary>
        public InputMap<string> CredentialMappingOverrides
        {
            get => _credentialMappingOverrides ?? (_credentialMappingOverrides = new InputMap<string>());
            set => _credentialMappingOverrides = value;
        }
        ...
        public CredentialLibraryVaultArgs()
        {
        }
        public static new CredentialLibraryVaultArgs Empty => new CredentialLibraryVaultArgs();
    }

    public sealed class CredentialLibraryVaultState : global::Pulumi.ResourceArgs
    {
        [Input("credentialMappingOverrides")]
        private InputMap<string>? _credentialMappingOverrides;
        ...
        public CredentialLibraryVaultState()
        {
        }
        public static new CredentialLibraryVaultState Empty => new CredentialLibraryVaultState();
    }
}
