...
//
// Deprecated: The value for this field will be infered since 'password' is the only possible value.
func (o AccountPasswordOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AccountPassword) pulumi.StringPtrOutput { return v.Type }).(pulumi.StringPtrOutput)
}
