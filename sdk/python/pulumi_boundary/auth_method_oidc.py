...
class AuthMethodOidcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_url_prefix: The API prefix to use when generating callback URLs for the provider. Should be set to an address at which the provider
        ...
        :param pulumi.Input[str] client_secret: The secret key assigned to this auth method from the provider. Once set, only the hash will be kept and the original
               value can be removed from configuration.
        :param pulumi.Input[str] client_secret_hmac: The HMAC of the client secret returned by the Boundary controller, which is used for comparison after initial setting of
               the value.
        :param pulumi.Input[str] description: The auth method description.
        :param pulumi.Input[bool] disable_discovered_config_validation: Disables validation logic ensuring that the OIDC provider's information from its discovery endpoint matches the
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] prompts: The prompts passed to the identity provider to determine whether to prompt the end-user for reauthentication, account
...
class AuthMethodOidc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            signing_algorithms: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            state: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'AuthMethodOidc':
        """
    ...
    @property
    @pulumi.getter
    def prompts(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        The prompts passed to the identity provider to determine whether to prompt the end-user for reauthentication, account
        selection or consent. Please note the values passed are case-sensitive. The valid values are: `none`, `login`, `consent`
        and `select_account`.
