...
class _ExportableConfig(types.ModuleType):
    ...
    @property
    def auth_method_login_name(self) -> Optional[str]:
        """
        The auth method login name for password-style or ldap-style auth methods
        """
        return __config__.get('authMethodLoginName')

    @property
    def auth_method_password(self) -> Optional[str]:
        """
        The auth method password for password-style or ldap-style auth methods
        """
        return __config__.get('authMethodPassword')
