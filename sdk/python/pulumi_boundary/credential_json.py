...
class CredentialJsonArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] object: The object for the this json credential. Either values encoded with the "jsonencode" function, pre-escaped JSON string,
               or a file
...
class CredentialJson(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CredentialJson resource with the given unique name, props, and options.
