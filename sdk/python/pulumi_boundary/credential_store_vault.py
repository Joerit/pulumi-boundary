...
__all__ = ['CredentialStoreVaultArgs', 'CredentialStoreVault']

@pulumi.input_type
class CredentialStoreVaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] worker_filter: HCP Only. A filter used to control which PKI workers can handle Vault requests. This allows the use of private Vault
...
@pulumi.input_type
class _CredentialStoreVaultState:
    def __init__(__self__, *,
...
class CredentialStoreVault(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CredentialStoreVault resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CredentialStoreVaultArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CredentialStoreVault resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CredentialStoreVaultArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CredentialStoreVaultArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CredentialStoreVaultArgs.__new__(CredentialStoreVaultArgs)
            ...
            __props__.__dict__["client_certificate_key"] = None if client_certificate_key is None else pulumi.Output.secret(client_certificate_key)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["clientCertificateKey", "token"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(CredentialStoreVault, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            token: Optional[pulumi.Input[str]] = None,
            token_hmac: Optional[pulumi.Input[str]] = None,
            worker_filter: Optional[pulumi.Input[str]] = None) -> 'CredentialStoreVault':
        """
        ...
        __props__ = _CredentialStoreVaultState.__new__(_CredentialStoreVaultState)
        ...
        __props__.__dict__["worker_filter"] = worker_filter
        return CredentialStoreVault(resource_name, opts=opts, __props__=__props__)
