...
class CredentialStoreVaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] worker_filter: HCP Only. A filter used to control which PKI workers can handle Vault requests. This allows the use of private Vault instances with Boundary.
        """
