...
class HostSetPluginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] attributes_json: The attributes for the host set. Either values encoded with the "jsonencode" function, pre-escaped JSON string, or a
...
class HostSetPlugin(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a HostSetPlugin resource with the given unique name, props, and options.
