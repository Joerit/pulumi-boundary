...
class RoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] grant_scope_id: For Boundary 0.15+, use `grant_scope_ids` instead. The scope for which the grants in the role should apply.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] grant_scope_ids: A list of scopes for which the grants in this role should apply, which can include the special values "this", "children", or "descendants"
        ...
        if grant_scope_id is not None:
            warnings.warn("""In Boundary 0.15+, please use `grant_scope_ids` instead. This field will be removed in a future release.""", DeprecationWarning)
            pulumi.log.warn("""grant_scope_id is deprecated: In Boundary 0.15+, please use `grant_scope_ids` instead. This field will be removed in a future release.""")
        if grant_scope_id is not None:
    ...
    @_utilities.deprecated("""In Boundary 0.15+, please use `grant_scope_ids` instead. This field will be removed in a future release.""")
