...
class ScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] global_scope: Indicates that the scope containing this value is the global scope, which triggers some specialized behavior to allow it
...
class Scope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            global_scope: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            scope_id: Optional[pulumi.Input[str]] = None) -> 'Scope':
        """
