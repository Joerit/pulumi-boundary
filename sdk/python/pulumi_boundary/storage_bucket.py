...
class StorageBucketArgs:
    def __init__(__self__, *,
                 ...
                 worker_filter: pulumi.Input[str],
        ...
        :param pulumi.Input[str] bucket_name: The name of the bucket within the external object store service.
        :param pulumi.Input[str] scope_id: The scope for this storage bucket.
        :param pulumi.Input[str] worker_filter: Filters to the worker(s) that can handle requests for this storage bucket. The filter must match an existing worker in
               order to create a storage bucket.
        :param pulumi.Input[str] attributes_json: The attributes for the storage bucket. The "region" attribute field is required when creating an AWS storage bucket.
        ...
        :param pulumi.Input[str] bucket_prefix: The prefix used to organize the data held within the external object store.
        :param pulumi.Input[str] description: The storage bucket description.
        :param pulumi.Input[str] name: The storage bucket name. Defaults to the resource name.
        ...
        :param pulumi.Input[str] secrets_json: The secrets for the storage bucket. Either values encoded with the "jsonencode" function, pre-escaped JSON string, or a
    ...
    def worker_filter(self) -> pulumi.Input[str]:
        """
    ...
    def worker_filter(self, value: pulumi.Input[str]):
...
class _StorageBucketState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] internal_hmac_used_for_secrets_config_hmac: Internal only. The Boundary-provided HMAC used to calculate the current value of the HMAC'd config. Used for drift
               detection.
...
class StorageBucket(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["secrets_json"] = None if secrets_json is None else pulumi.Output.secret(secrets_json)
            if worker_filter is None and not opts.urn:
                raise TypeError("Missing required property 'worker_filter'")
            __props__.__dict__["worker_filter"] = worker_filter
            __props__.__dict__["internal_force_update"] = None
            __props__.__dict__["internal_hmac_used_for_secrets_config_hmac"] = None
            __props__.__dict__["internal_secrets_config_hmac"] = None
            __props__.__dict__["secrets_hmac"] = None
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["secretsJson"])
    ...
    def get(resource_name: str,
            ...
            secrets_hmac: Optional[pulumi.Input[str]] = None,
            secrets_json: Optional[pulumi.Input[str]] = None,
            worker_filter: Optional[pulumi.Input[str]] = None) -> 'StorageBucket':
        """
    ...
    @property
    @pulumi.getter(name="pluginName")
    def plugin_name(self) -> pulumi.Output[Optional[str]]:
        """
        The name of the plugin that should back the resource. This or plugin_id must be defined.
        """
        return pulumi.get(self, "plugin_name")
    ...
    @property
    @pulumi.getter(name="workerFilter")
    def worker_filter(self) -> pulumi.Output[str]:
        """
        Filters to the worker(s) that can handle requests for this storage bucket. The filter must match an existing worker in
        order to create a storage bucket.
        """
