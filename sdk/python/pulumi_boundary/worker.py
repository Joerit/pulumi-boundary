...
class WorkerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] worker_generated_auth_token: The worker authentication token required to register the worker for the worker-led authentication flow. Leaving this
...
class Worker(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Worker resource with the given unique name, props, and options.
